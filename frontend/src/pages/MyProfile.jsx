    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
        ...
        <div>
          ...
          <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
            ...
            {
              isEdit 
              ? <input className='bg-gray-100' type="text" value={userData.city} onChange={e => setUserData(prev => ({...prev,city:e.target.value}))} />
        ...
        <div className='mt-10'>
          {
            ...
            ? <button
                  disabled={loading}
                  className={`border border-primary px-8 py-2 rounded-full transition-all duration-500 
                    ${loading ? 'bg-primary text-white opacity-70 cursor-not-allowed' : 'hover:bg-primary hover:text-white'}`}
