...
import { Users, CalendarDays, BadgeIndianRupee } from 'lucide-react' // Optional: install lucide-react
  ...
  return dashData && (
    <div className="w-full max-w-6xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white shadow-md border rounded-xl p-6 flex flex-col items-center text-center hover:shadow-lg transition">
          <BadgeIndianRupee className="text-green-500 w-8 h-8 mb-2" />
          <p className="text-gray-500 text-sm">Total Earnings</p>
          <p className="text-2xl font-semibold text-green-700">{dashData.earnings}</p>
        </div>
        <div className="bg-white shadow-md border rounded-xl p-6 flex flex-col items-center text-center hover:shadow-lg transition">
